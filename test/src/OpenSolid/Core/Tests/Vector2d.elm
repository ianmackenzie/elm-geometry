...
module OpenSolid.Core.Tests.Vector2d exposing (suite)
...
import OpenSolid.Core.Test.Comparisons exposing (valueIsOne, valueIsZero)
import OpenSolid.Core.Test.Producers exposing (vector2d)
