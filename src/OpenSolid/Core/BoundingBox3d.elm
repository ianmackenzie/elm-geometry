module OpenSolid.Core.BoundingBox3d (empty, whole, singleton, hull, hullOf, intersection, fromComponents, components, isEmpty, midpoint, contains, overlaps) where
...
intersection (BoundingBox3d otherX otherY otherZ) (BoundingBox3d x y z) =
  let
    ...
    z' =
      Interval.intersection otherZ z
  in
