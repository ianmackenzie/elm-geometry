module OpenSolid.Core.LineSegment3d (fromEndpoints, endpoints, map, mapTo, vector, direction, normalDirection, squaredLength, length, scaleAbout, rotateAbout, translateBy, mirrorAbout, projectOntoAxis, projectOnto, projectInto, boundingBox) where
