module OpenSolid.Core.Triangle2d (fromVertices, vertices, edges, map, mapTo, scaleAbout, rotateAbout, translateBy, mirrorAbout, placeOnto, area, centroid, boundingBox) where
